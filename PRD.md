...
- **Functionality**: Create spending budgets with target amounts for specific time periods (monthly, quarterly, annual) that can be scoped to all expenses, a specific category, or a specific account
- **Purpose**: Help users set financial goals, control spending, and stay aware of their budget limits through real-time progress tracking
- **Trigger**: Click "Nuovo Budget" button in Reports tab
